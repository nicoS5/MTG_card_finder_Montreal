...
st.markdown(
"""
Cet outil vous permettra de rechercher des cartes du jeu Magic The Gathering dans les magasins de Montreal. A date, les magasins disponibles sont les suivant :
- Le Valet de coeur
- L'expedition
- Alt F4
- Carta Magica
- Chez Geeks
- Games Keeper Lajeunesse
            
L'outil est diviser en **2 sections** qui vous permettront de faire 2 actions distinctes :
""")
...
st.markdown(
"""
Pour commencer vos recherches de carte dirigez-vous vers l'onglet **"☝️Chercher une carte"** ou **"🔦Chercher un deck"**.

Si vous voulez consultez le prix des cartes deja recherchees, dirigez-vous vers l'onglet **💲Acheter un deck**. 
""")
